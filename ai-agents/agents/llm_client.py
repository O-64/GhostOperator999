...
def call_gemini(prompt: str, system_instruction: str = "") -> str:
    """Call Google Gemini 2.5 Flash API via native HTTP request."""
...
def call_groq(prompt: str, system_instruction: str = "", model: str = "qwen/qwen3.8-27b") -> str:
...
def call_llm(prompt: str, system_instruction: str = "", prefer_json: bool = True) -> str:
    """Unified LLM caller with Gemini primary and Groq fallback."""
